                            ...
                            <form v-if="user!=''" v-show="itemDetails.comments==0" class="ql-container" method="post" >
                                ...
                                <div class="" v-for="user in usersAll" >
                                    <h6 @click="emitUser(user.name)" style="border-bottom: 1px solid black; cursor: pointer;">{{ user.name }}</h6>
                                                           ...
                                                           <QuillEditor v-if="user.role!=1"  @input="check()"  v-model:content="Comment" v-model:name="Comment" contentType="html" placeholder="Write your comment..." toolbar="minimal" theme="snow" />
                                                           <QuillEditor v-else  @input="check()"  v-model:content="Comment" v-model:name="Comment" contentType="html" placeholder="Write your comment..." toolbar="full" theme="snow" />
